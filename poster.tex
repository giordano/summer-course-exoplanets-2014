...
% sky blue
\definecolor{taskyblue}{rgb}{0.34706, 0.56078, 0.81176}		% #728fcf
\definecolor{ta2skyblue}{rgb}{0.10392, 0.39608, 0.64314}	% #3465a4
\definecolor{ta3skyblue}{rgb}{0.02549, 0.29020, 0.52941}	% #204a87

\definecolor{LightSteelBlue}{rgb}{.5, .77, .87}

\selectcolormodel{cmyk}

\setbeamercolor{headline}{fg=tabutter,bg=ta3skyblue}
\setbeamercolor{footline}{fg=tabutter, bg=ta3skyblue}
\setbeamerfont{footline}{size=\large}
\setbeamercolor{separation line}{bg=ta2orange}
\setbeamercolor{title in headline}{fg=taorange}
\setbeamercolor{author in headline}{fg=ta2orange}
\setbeamercolor{institute in headline}{fg=ta2orange}
...
\setbeamercolor*{normal text}{fg=tachameleon, bg=LightSteelBlue}
...
\setbeamercolor{alerted text}{fg=ta3orange}

%\setbeamercolor{example text}{fg=taorange}
\setbeamercolor{structure}{fg=ta2skyblue}
