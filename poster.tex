  ...
  \begin{beamercolorbox}[wd=\paperwidth]{headline}
    \begin{columns}[T]
      ...
      \begin{column}{.12\paperwidth}
        \begin{center}
          \includegraphics[width=0.8\columnwidth]{figures/giordano.jpg} \\[1.2ex]
          \href{mailto:Mose.Giordano@le.infn.it}{mose.giordano@le.infn.it}~
          \(\vcenter{\hbox{\includegraphics[scale=1.17]{figures/mail}}}\)
        \end{center}
      \end{column}
...
\newcommand{\pro}{\color{green}\ding{51}}
\newcommand{\con}{\color{red}\ding{55}}
      ...
      \begin{minipage}[T]{\columnwidth}
        ...
        \begin{block}{Reference\hfill \blocknumber{7}}
          ...
          \item[{\includegraphics[scale=2]{figures/beamericonarticle-crop.pdf}}]
            ...
            \(\vcenter{\hbox{\includegraphics[scale=1.02]{figures/paper}}}\)).
            \arxiv{1401.6288} (scan here:
            \(\vcenter{\hbox{\includegraphics[scale=1.17]{figures/arxiv}}}\)).
          \end{itemize}
        \end{block}
      \end{minipage}
    \end{column}
